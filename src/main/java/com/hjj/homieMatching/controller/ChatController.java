...
public class ChatController {
    ...
    public String chatWithAi(String question,HttpServletRequest request) {
        // request中应包含userId（用户ID）和question（问题内容）
        User loginUser = userService.getLoginUser(request);
        return chatService.chatWithAiAndSave(question,loginUser);
    }
}
